...
PLAN_FEATURES = {
    "Basic - 20.000đ": [
        ...
        "🇻🇳 Trả lời tiếng Việt",
        "⚙️ Lệnh /cloud ai",
        "🛠️ Cấu hình tên, avatar, tính cách",
    ],
    "VIP - 40.000đ": [
        "💬 Tất cả tính năng Basic",
        "🎮 Hỗ trợ Minecraft / Paper / Plugin",
        "🛡️ Moderation cơ bản",
        "👋 Welcome",
        "🎨 Embed tùy chỉnh",
        "🧠 Memory nâng cao",
    ...
    "Premium - 60.000đ": [
        ...
        "🤖 Auto Chat",
        "🎤 Voice AI (khi được triển khai)",
        "⚙️ Lệnh tùy chỉnh",
        "🎨 Tùy chỉnh tính cách nâng cao",
        "🚀 Ưu tiên hỗ trợ",
    ],
    "Custom": [
        "👑 Thiết kế bot theo yêu cầu",
        "⚙️ Chức năng tùy chỉnh",
        "🎨 Giao diện/tính cách tùy chọn",
        "💬 Báo giá riêng",
    ],
}
...
def get_plan_features(plan):
    """Lấy danh sách tính năng theo gói."""
    return PLAN_FEATURES.get(plan, ["⚙️ Cấu hình theo yêu cầu"])
...
def create_store_features_embed():
    ...
    for plan in (
        ...
        embed.add_field(
            name=f"📦 {plan}",
            value=format_plan_features(plan),
            inline=False
        )
